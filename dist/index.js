...
var TUIContext = createContext(null);
...
function TUIRoot({
  ...
  const [flavor, setFlavorState] = useState(initialFlavor);
  const rootRef = useRef(null);
  const containerRegistry = useRef(/* @__PURE__ */ new Map());
  useEffect(() => {
    injectBaseCSS();
  ...
  const setFlavor = useCallback((f) => setFlavorState(f), []);
  ...
  const getContainerRect = useCallback((id) => {
  ...
  return /* @__PURE__ */ jsx(TUIContext.Provider, { value: ctx, children: /* @__PURE__ */ jsxs(
    "div",
    {
      "data-tui-root": "",
...
var REP = 200;
function HFill({ char }) {
  return /* @__PURE__ */ jsx(Fragment, { children: char.repeat(REP) });
}
function VFill({ char }) {
  return /* @__PURE__ */ jsx(Fragment, { children: (char + "\n").repeat(REP) });
}
function TopFill({ char, title, titleSide }) {
  if (!title) {
    return /* @__PURE__ */ jsx(HFill, { char });
  }
  const label = ` ${title} `;
  const anchor = char + char;
  if (titleSide === "right") {
    return /* @__PURE__ */ jsxs("div", { style: { display: "flex", width: "100%", overflow: "hidden", whiteSpace: "pre" }, children: [
      /* @__PURE__ */ jsx("span", { style: { flex: 1, overflow: "hidden" }, children: /* @__PURE__ */ jsx(HFill, { char }) }),
  ...
  if (titleSide === "center") {
    return /* @__PURE__ */ jsxs("div", { style: { display: "flex", width: "100%", overflow: "hidden", whiteSpace: "pre" }, children: [
      /* @__PURE__ */ jsx("span", { style: { flex: 1, overflow: "hidden" }, children: /* @__PURE__ */ jsx(HFill, { char }) }),
      /* @__PURE__ */ jsx("span", { style: { flexShrink: 0 }, children: label }),
      /* @__PURE__ */ jsx("span", { style: { flex: 1, overflow: "hidden" }, children: /* @__PURE__ */ jsx(HFill, { char }) })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", width: "100%", overflow: "hidden", whiteSpace: "pre" }, children: [
...
function Container({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      style: outerStyle,
      children: [
        hasBorder && c && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("span", { "aria-hidden": true, style: { ...borderStyle, top: 0, left: 0, width: "1ch", height: CELL_H, overflow: "visible" }, children: c.tl }),
          /* @__PURE__ */ jsx("span", { "aria-hidden": true, style: { ...borderStyle, top: 0, right: 0, width: "1ch", height: CELL_H, overflow: "visible" }, children: c.tr }),
          /* @__PURE__ */ jsx("span", { "aria-hidden": true, style: { ...borderStyle, bottom: 0, left: 0, width: "1ch", height: CELL_H, overflow: "visible" }, children: c.bl }),
          /* @__PURE__ */ jsx("span", { "aria-hidden": true, style: { ...borderStyle, bottom: 0, right: 0, width: "1ch", height: CELL_H, overflow: "visible" }, children: c.br }),
          /* @__PURE__ */ jsx("div", { "aria-hidden": true, style: { ...borderStyle, top: 0, left: "1ch", right: "1ch", height: CELL_H, display: "flex", alignItems: "flex-start" }, children: /* @__PURE__ */ jsx(TopFill, { char: c.h, title, titleSide }) }),
          /* @__PURE__ */ jsx("div", { "aria-hidden": true, style: { ...borderStyle, bottom: 0, left: "1ch", right: "1ch", height: CELL_H }, children: /* @__PURE__ */ jsx(HFill, { char: c.h }) }),
          /* @__PURE__ */ jsx("div", { "aria-hidden": true, style: { ...borderStyle, top: CELL_H, bottom: CELL_H, left: 0, width: "1ch" }, children: /* @__PURE__ */ jsx(VFill, { char: c.v }) }),
          /* @__PURE__ */ jsx("div", { "aria-hidden": true, style: { ...borderStyle, top: CELL_H, bottom: CELL_H, right: 0, width: "1ch" }, children: /* @__PURE__ */ jsx(VFill, { char: c.v }) })
        ] }),
        /* @__PURE__ */ jsx("div", { style: innerStyle, children })
      ]
    }
  );
}
...
function BigText({
  ...
  if (error) {
    return /* @__PURE__ */ jsxs("span", { style: { color: "var(--tui-error)" }, children: [
      "BigText error: ",
      error
    ] });
  }
  if (output === null) {
    return /* @__PURE__ */ jsx(Fragment, { children: fallback ?? /* @__PURE__ */ jsx("span", { style: { color: "var(--tui-fg-subtle)" }, children: "..." }) });
  }
  return /* @__PURE__ */ jsx(
    "pre",
    {
...
function useCellSize(rootRef) {
  const [size, setSize] = useState({ w: 8, h: 16.8 });
  useEffect(() => {
